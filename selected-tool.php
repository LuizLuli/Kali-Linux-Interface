...
<body>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="d-flex justify-content-between">
                <button data-container="body" data-toggle="popover" data-placement="right" class="btn btn-sm btn-info mr-4" data-content="<?php echo $resume; ?> ">Sobre</button>
                <button class="btn btn-sm btn-default float-right" data-toggle="collapse" data-target="#commands" type="button"><i class="ni ni-bold-right"> </i> Comandos</button>
              </div>
            </div>
                        ...
                        if(is_null($description)) {
                          ...
                          echo "
                            <a target='_blank' href='$description'>
                              <span class='heading'><i class='ni ni-single-copy-04 text-default'></i></span>
                              <span class='description text-primary'>Descrição</span>
                            </a>
                          ";
                        }
                      ?>
                      ...
                      <?php
                        if(is_null($github)) {
                          echo "
                            ...
                            <span class='description'>Código Fonte</span>
                          ";
                        } else {
                          echo "
                            <a target='_blank' href='$github'>
                              <span class='heading'><i class='ni ni-bold-right text-green'></i></span>
                              <span class='description text-primary'>Código Fonte</span>
                            </a>
                          ";
                        }
                      ?>
          ...
          if (!is_null($category2)) {
            echo ", $category2";
                ...
                <div class="col-sm-12 offset-md-3 col-md-6">
                    ...
                    <p>Insira o endereço do alvo: </p>

                    <div class="form-group">
                  <input id='target' type="text" placeholder="Exemplo: 127.0.0.1" class="form-control is-valid" onchange="getTarget();" />
                </div>
                </div>
                
                <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#options"> + Opções</button>
                <button class="btn btn-default" type="button" onclick="execute();"><i class="ni ni-bold-right"></i> Executar</button>
                <br><br>

                <div class="collapse options" id="options">
                  <h6 class="heading-small text-muted mb-4">Requer Entrada de dados</h6>
  ...
  <script type="text/javascript">
    ...
    function execute() {
        ...
        document.getElementById("terminal-data").innerHTML = "Carregando...";
        /* GET target */
