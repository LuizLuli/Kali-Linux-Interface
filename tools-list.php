        ...
        <div class="col">
          	<div class="card shadow">
	            <div class="card-header bg-transparent">
	              <h2 class="mb-0">Ferramentas
					<!--<button class="btn btn-dark btn-sm float-right" type="button" data-toggle="collapse" data-target="#collapse-filter" style="float: right;">+ Ver filtros</button>-->
	              </h2>
												...
												<div class='card zoom-effect bg-white mb-3 text-white'>
													<div class='card-body'>
									                  ...
									                  <p class='mt-3 mb-0 text-muted'>
									                    <span class='text-danger mr-2'>Indisponível</span>
											...
											<a href='selected-tool.php?id=$id' style='text-decoration: none;'>
												<div class='card zoom-effect mb-3 text-white bg-success'>
													<div class='card-body'>
									                  ...
									                  <p class='mt-3 mb-0 text-muted'>
									                    <span class='text-white mr-2'>Disponível</span>
									                    <span class='text-nowrap'></span>
									                  </p>
												  	</div>
												</div>
