    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row">
        <div class="col">
              ...
              <h1><?php echo $name; ?></h1>
              <span>
                Ferramenta utilizada: <?php echo $tools; ?> </span><br><br>
                Varredura realizada em: <span><?php echo $dataHour; ?>hrs <br><br>
                Comando executado:<b> <?php echo $command; ?></b>
                ...
                <div class="col">  
                  <div class="solution" id="solution" >
                    <div class="card card-body text-white bg-success">
                      ...
                      <h2 class="card-title text-white"><i class="ni ni-bold-right"></i> Solução</h2>            
