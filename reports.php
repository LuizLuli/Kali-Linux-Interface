				...
				<div class="col-xl-6 col-lg-6">
                    <div class="card card-stats zoom-effect">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            ...
                            <span class="h3 font-weight-bold mb-0">
                             ...
                             <br><p><b>Data/Hora:</b> <?php echo $dataHour; ?>hrs</p>
                          </div>
                          <div class="col-auto">
                        ...
                        <?php echo "<a href='selected-report.php?id=$id' style='text-decoration: none;' class='btn btn-info'>+ Ver detalhes</a>" ?>

                        <?php echo "<a href='delete-reports.php?id=$id' style='text-decoration: none;' class='btn btn-danger'>Remover</a>" ?>
                      </div>
                    </div>
                  </div>
